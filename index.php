...
Plugin URI: 
Description: A plugin to create Slider of multiple Images. Add shortcode [img_silder url="image_url,image_url,image_url"] in any page to get slider of images. Replace img url to the desired url of the image in shortcode.
    ...
    $output .= '<div class="carousel-inner">';
      foreach ( $ids_array as $img_url ){
        $output .= '<div class="item ">
            <img src="'.$img_url.'" alt="Image" style="width:100%;">
          </div>';
      }
...
add_shortcode('img_slider', 'create_slider_function');
